(function () {
  ...
  Game.prototype.draw = function(ctx, img) {
    ...
    ctx.fillStyle = 'red';
    ctx.font="27px sans-serif red";
    ctx.fillText("Lives left: " + this.lives, 390, 30);
    ctx.fillText("Shields left: " + this.ship.shields, 620, 30);
    ctx.fillText("Asteroids Destroyed: " + this.asteroidsDestroyed, 880, 30);
    ctx.fillText("Level: " + this.level, 640, 570);
