(function () {
  ...
  Asteroid.prototype.collideWith = function(otherObject) {
    if (otherObject instanceof Asteroids.Ship || otherObject instanceof Asteroids.Bullet) {
        var explosion = new Asteroids.Explosion(this.pos.slice(0), this.game, this.radius);
